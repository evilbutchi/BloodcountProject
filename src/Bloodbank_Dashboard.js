      ...
      <div className="Header" style={{ position: 'relative' }}>
        <div className="LogoAndTitle" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <TextField
            ...
            variant="outlined"
            style={{ width: 288, height: 55, background: 'white', borderRadius: 100, border: '1px #FFC3C3 solid', marginLeft: -160, marginRight: 20, marginTop: 100 }}
          />
        </div>
        ...
        <div className="Buttons" style={{ gap: '30px', marginRight: '50px', marginTop: '-65px' }}>
          <Button variant="outlined" onClick={() => navigate("/Register_User")} style={{ color: '#861530', fontSize: 18, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: 5, border: '2px solid #861530' }} >Logout</Button>
        </div>
      </div>
    );
  };
    ...
    <div className="App">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginLeft: 20, marginRight: 20, flexDirection: 'column' }}>
        <div style={{ textAlign: 'right', marginRight: 10 }}>
          <div className="Hospitals" style={{width: 226, height: 48, color: '#861530', fontSize: 24, fontFamily: 'Poppins', fontWeight: '700', wordWrap: 'break-word', marginLeft: -790, marginRight: 20, marginTop: 20 }}>Hospitals</div>
      ...
      {/* Rest of the content */}
      <div className="Content" style={{ marginTop: 20, marginLeft: -800, marginRight: 20 }}>
